                        ...
                        <div class="row" id="wrapper-options">
                            ...
                            <div class="foods-options col-12 mb-5" data-option="temp-option" style="display:none;">
                                <div class="option_title mt-10">
                                    ...
                                    <input type="text"
                                           data-option="option_title" id="option_title_0"
                                           class="form-control mb-3 col-10" name="option_title[0]"
                                           placeholder="Enter Option Title" data-groupname="option_0">
                                    <button class="btn btn-success col-0 add_option_options"
                                            data-target="option-temp" data-groupname="option_0">
                                        <i class="fa fa-plus"></i>
                                    </button>
                                </div>
                                <div class="option_options mt-2" data-optionparent="temp-option">
                                    <div class="row">
                                        <input type="text" name="option_value[0][]"
                                               class="form-control col-4" data-optionoption="option_0"
                                               data-optiontype="value" placeholder="Option Value">
                                        <input type="text" name="option_price[0][]"
                                               class="form-control col-3" data-optionoption="option_0"
